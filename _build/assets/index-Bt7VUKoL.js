...
import{q as se,b as r,H as Ee,t,w as o,F as E,A as e,j as n,S as M,z as k,I as S,m as Me,d as Pe,J as Te}from"./web-CH6RNnj1.js";import{_ as Y}from"./preload-helper-DjB3CTiX.js";var je=o('<div class="standard-dialog center scale-down"id=parse-modal><div class=modal-contents><h1 class=modal-text>Error during build!</h1><p></p><section class=field-row style=justify-content:flex-end><button class=btn>OK'),Oe=o('<div class="standard-dialog center scale-down"id=parse-modal><div class=modal-contents><h1 class=modal-text>Parse Results</h1><details><summary>Tokens</summary><ol></ol></details><details><summary>Instructions</summary><ol></ol></details><details><summary>Expressions</summary><ol></ol></details><details><summary>Labels</summary><ol></ol></details><section class=field-row style=justify-content:flex-end><button class=btn>OK'),Ie=o(`<div id=editor><ul role=menu-bar><li role=menu-item tabindex=0 aria-haspopup=true>File<ul role=menu><li role=menu-item><button>Save Source</button></li><li role=menu-item><button>Save Build</button></li><li role=menu-item><button>Load</button></li></ul></li><li role=menu-item tabindex=1 aria-haspopup=true>Test<ul role=menu><li role=menu-item><button>Parse</button></li></ul></li><li role=menu-item tabindex=2 aria-haspopup=true>Build<ul role=menu><li role=menu-item><button>Json</button></li><li role=menu-item><button>Binary</button></li></ul></li></ul><div style=display:flex;width:100%><textarea>@label start;
LD :1 0
LD #110 :1
LD #97 :1
LD #108 :1
